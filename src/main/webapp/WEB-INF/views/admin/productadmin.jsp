			...
			<section class="content">
						<form action="saveProduct" method="post" class="row" enctype="multipart/form-data">							
							...
							<div class="col-md-6 mb-3">
								<label for="username" class="form-label">Product Name:</label> <input
									type="text" id="productname" name="productname" value="${product.productname}"
									class="form-control">
							</div>
							
							<div class="col-md-6 mb-3">
								<label for="username" class="form-label">Product Description:</label> <input
									type="text" id="productdescription" name="productdescription" value="${product.productdescription}"
									class="form-control">
							</div>
							
							<div class="col-md-6 mb-3">
								<label for="username" class="form-label">Product Image:</label> <input
									type="file" id="productimage" name="productimage" accept="image/*" value="${product.productimage}"
									class="form-control">
							</div>
							
							<div class="col-md-6 mb-3">
								<label for="username" class="form-label">Product Price:</label> <input
									type="text" id="productprice" name="productprice" value="${product.productprice}"
									class="form-control">
							</div>
							
							<div class="col-md-6 mb-3">
								<label for="password" class="form-label" >Product Activate:</label> <input
									type="checkbox" id="productactivate" name="productactivate"
									value="${product.productactivate}" class="form-control" ${product.productactivate ? 'checked' : ''}>
							</div>	
							<div class="col-md-6 mb-3">
								<label for="password" class="form-label">Product Sale</label> <input
									type="text" id="productsale" name="productsale"
									value="${product.productsale}" class="form-control" >
							</div>						
							<div class="col-md-6 mb-3">
							<label for="" class="">Hành Động:</label><br>
							...
							<tbody>
								<c:forEach items="${products}" var="product">
									<tr>
										...
										<td>${product.productactivate }</td>
										<td>${product.productsale }</td>
										<td><a href="/product/edit/${product.productId}">Edit</a>
