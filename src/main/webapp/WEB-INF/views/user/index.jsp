                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide position-relative h-100 w-100">
                                    <div
                                        ...
                                        <div class="w-100 h-100 bg-img-cover bg-pos-center-center overflow-hidden"
                                            ...
                                            style=" will-change: transform; background-image: url(images/banners/banner-1.jpg)">
                                        </div>
                                    </div>
                                    <div
                                        ...
                                        <h2 class="display-3 tracking-wide fw-bold text-uppercase tracking-wide text-white"
                                            data-swiper-parallax="100">
                                            <span class="text-outline-light">Summer</span> Iphone
                                        </h2>
                                ...
                                <div class="swiper-slide position-relative h-100 w-100">
                                    <div
                                        ...
                                        <div class="w-100 h-100 bg-img-cover bg-pos-center-center overflow-hidden"
                                            data-swiper-parallax="-100"
                                            style=" will-change: transform; background-image: url(images/banners/banner-2.jpg)">
                                        </div>
                                    </div>
                                    <div
                                        class="container position-relative z-index-10 d-flex h-100 align-items-start flex-column justify-content-center">
                                        ...
                                        <h2 class="display-3 tracking-wide fw-bold text-uppercase tracking-wide text-white"
                                            data-swiper-parallax="100">
                                            SamSung <span class="text-outline-light">SS23</span></h2>
                                        <div data-swiper-parallax-y="-25">
                                            <a href="./category.html" class="btn btn-psuedo text-white"
                                                role="button">Shop Latest SamSung</a>
                                        </div>
                                    </div>
                                </div>
                                <!--/Slide-->
                                ...
                                <div class="swiper-slide position-relative h-100 w-100">
                                    <div
                                        ...
                                        <div class="w-100 h-100 bg-img-cover bg-pos-center-center overflow-hidden"
                                            data-swiper-parallax="-100"
                                            style=" will-change: transform; background-image: url(images/banners/banner-4.jpg)">
                                        </div>
                                    </div>
                                    <div
                                        class="container position-relative z-index-10 d-flex h-100 align-items-start flex-column justify-content-center">
                                        ...
                                        <h2 class="display-3 tracking-wide fw-bold text-uppercase tracking-wide text-white"
                                            data-swiper-parallax="100">
                                            Xiaomi <span class="text-outline-light">SS23</span></h2>
                                        <div data-swiper-parallax-y="-25">
                                            <a href="./category.html" class="btn btn-psuedo text-white"
                                                role="button">Shop Latest Xiaomi</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- /Slide-->
                                ...
                                <div class="swiper-slide position-relative h-100 w-100">
                                    <div
                                        ...
                                        <div class="w-100 h-100 bg-img-cover bg-pos-center-center overflow-hidden"
                                            data-swiper-parallax="-100"
                                            style=" will-change: transform; background-image: url(images/banners/banner-3.jpg)">
                                        </div>
                                    </div>
                                    <div
                                        class="container position-relative z-index-10 d-flex h-100 align-items-start flex-column justify-content-center">
                                        ...
                                        <h2 class="display-3 tracking-wide fw-bold text-uppercase tracking-wide text-white"
                                            data-swiper-parallax="100">
                                            <span class="text-outline-light">Sustainable</span> NewPhone
                                        </h2>
                                        <div data-swiper-parallax-y="-25">
                                            <a href="./category.html" class="btn btn-psuedo text-white"
                                            ...
                                            <a class="d-block" href="./category.html">
                                                <picture>
                                                    <img class="img-fluid d-table mx-auto" alt=""
                                                        src="<c:url value='images/logos/logo-1.svg' />">
                                                </picture>
                                            </a>
                                        </div>
                                        <div class="mx-3 mx-lg-5 f-w-24">
                                            <a class="d-block" href="./category.html">
                                                <picture>
                                                    <img class="img-fluid d-table mx-auto" alt=""
                                                        src="<c:url value='images/logos/logo-2.svg' />">
                                                </picture>
                                            </a>
                                        </div>
                                        <div class="mx-3 mx-lg-5 f-w-24">
                                            <a class="d-block" href="./category.html">
                                                <picture>
                                                    <img class="img-fluid d-table mx-auto" alt=""
                                                        src="<c:url value='images/logos/logo-3.svg' />">
                                                </picture>
                                            </a>
                                        </div>
                                        <div class="mx-3 mx-lg-5 f-w-24">
                                            <a class="d-block" href="./category.html">
                                                <picture>
                                                    <img class="img-fluid d-table mx-auto" alt=""
                                                        src="<c:url value='images/logos/logo-4.svg' />">
                                                </picture>
                                            </a>
                                        </div>
                                        <div class="mx-3 mx-lg-5 f-w-24">
                                            <a class="d-block" href="./category.html">
                                                <picture>
                                                    <img class="img-fluid d-table mx-auto" alt=""
                                                        src="<c:url value='images/logos/logo-5.svg' />">
                                                </picture>
                                            </a>
                                        </div>
                                        <div class="mx-3 mx-lg-5 f-w-24">
                                            <a class="d-block" href="./category.html">
                                                <picture>
                                                    <img class="img-fluid d-table mx-auto" alt=""
                                                        src="<c:url value='images/logos/logo-6.svg' />">
                                                </picture>
                                            </a>
                                        </div>
                                        <div class="mx-3 mx-lg-5 f-w-24">
                                            <a class="d-block" href="./category.html">
                                                <picture>
                                                    <img class="img-fluid d-table mx-auto" alt=""
                                                        src="<c:url value='images/logos/logo-7.svg' />">
                                                </picture>
                                            </a>
                                        </div>
                                        <div class="mx-3 mx-lg-5 f-w-24">
                                            <a class="d-block" href="./category.html">
                                                <picture>
                                                    <img class="img-fluid d-table mx-auto" alt=""
                                                        src="<c:url value='images/logos/logo-8.svg' />">
                                                </picture>
                                            </a>
                                        </div>
                                        <div class="mx-3 mx-lg-5 f-w-24">
                                            <a class="d-block" href="./category.html">
                                                <picture>
                                                    <img class="img-fluid d-table mx-auto" alt=""
                                                        src="<c:url value='images/logos/logo-9.svg' />">
                                                </picture>
                                            </a>
                                        </div>
                                    </div>
                                        ...
                                        <div class="me-xl-n4 me-xxl-n5" data-aos="fade-up" data-aos-delay="000">
                                            <picture class="d-block mb-4 img-clip-shape-one">
                                                <img class="w-100" title=""
                                                    ...
                                                    src="<c:url value='images/categories/category-7.jpg' />">
                                            </picture>
                                    ...
                                    <div class="swiper-slide align-self-stretch bg-transparent h-auto">
                                        <div class="me-xl-n4 me-xxl-n5" data-aos="fade-up" data-aos-delay="100">
                                            <picture class="d-block mb-4 img-clip-shape-one">
                                                <img class="w-100" title=""
                                                    alt="HTML Bootstrap Template by Pixel Rocket"
                                                    src="<c:url value='images/categories/category-2.jpg' />">
                                            </picture>
                                    ...
                                    <div class="swiper-slide align-self-stretch bg-transparent h-auto">
                                        <div class="me-xl-n4 me-xxl-n5" data-aos="fade-up" data-aos-delay="200">
                                            <picture class="d-block mb-4 img-clip-shape-one">
                                                <img class="w-100" title=""
                                                    alt="HTML Bootstrap Template by Pixel Rocket"
                                                    src="<c:url value='images/categories/category-3.jpg' />">
                                            </picture>
                                    ...
                                    <div class="swiper-slide align-self-stretch bg-transparent h-auto">
                                        <div class="me-xl-n4 me-xxl-n5" data-aos="fade-up" data-aos-delay="300">
                                            <picture class="d-block mb-4 img-clip-shape-one">
                                                <img class="w-100" title=""
                                                    alt="HTML Bootstrap Template by Pixel Rocket"
                                                    src="<c:url value='images/categories/category-4.jpg' />">
                                            </picture>
                                    ...
                                    <div class="swiper-slide align-self-stretch bg-transparent h-auto">
                                        <div class="me-xl-n4 me-xxl-n5" data-aos="fade-up" data-aos-delay="400">
                                            <picture class="d-block mb-4 img-clip-shape-one">
                                                <img class="w-100" title=""
                                                    alt="HTML Bootstrap Template by Pixel Rocket"
                                                    src="<c:url value='images/categories/category-5.jpg' />">
                                            </picture>
                                    ...
                                    <div class="swiper-slide align-self-stretch bg-transparent h-auto">
                                        <div class="me-xl-n4 me-xxl-n5" data-aos="fade-up" data-aos-delay="500">
                                            <picture class="d-block mb-4 img-clip-shape-one">
                                                <img class="w-100" title=""
                                                    alt="HTML Bootstrap Template by Pixel Rocket"
                                                    src="<c:url value='images/categories/category-6.jpg' />">
                                            </picture>
                                    ...
                                    <div class="swiper-slide align-self-stretch bg-transparent h-auto">
                                        <div class="me-xl-n4 me-xxl-n5" data-aos="fade-up" data-aos-delay="600">
                                            <picture class="d-block mb-4 img-clip-shape-one">
                                                <img class="w-100" title=""
                                                    alt="HTML Bootstrap Template by Pixel Rocket"
                                                    src="<c:url value='images/categories/category-1.jpg' />">
                                            </picture>
                                            <p class="title-small mb-2 text-muted">Just Arrived</p>
                                            <h4 class="lead fw-bold">Samsung</h4>
                                            <a href="./category.html" class="btn btn-psuedo align-self-start">Shop
                                                Now</a>
                                        </div>
                                    </div>
                                    <div class="swiper-slide align-self-stretch bg-transparent h-auto">
                                        <div class="me-xl-n4 me-xxl-n5" data-aos="fade-up" data-aos-delay="700">
                                            <picture class="d-block mb-4 img-clip-shape-one">
                                                <img class="w-100" title=""
                                                    alt="HTML Bootstrap Template by Pixel Rocket"
                                                    src="<c:url value='images/categories/category-8.jpg' />">
                                            </picture>
                                ...
                                <div class="col-12 col-xl-6 position-relative" data-aos="fade-right">
                                    <picture class="position-relative z-index-10">
                                        <img class="w-100 rounded" alt="HTML Bootstrap Template by Pixel Rocket"
                                            src="<c:url value='images/banners/banner-sale.jpg' />">
                                    </picture>
                                    <div
                                            ...
                                            <div class="card position-relative overflow-hidden">
                                                <picture class="position-relative z-index-10 d-block bg-light">
                                                    <img class="w-100 rounded"
                                                        alt="HTML Bootstrap Template by Pixel Rocket"
                                                        src="<c:url value='images/banners/banner-8.jpg' />">
                                                </picture>
                                        ...
                                        <div class="col-12 col-md-6 d-flex">
                                            <div class="card position-relative overflow-hidden">
                                                <picture class="position-relative z-index-10 d-block bg-light">
                                                    <img class="w-100 rounded"
                                                        alt="HTML Bootstrap Template by Pixel Rocket"
                                                        src="<c:url value='images/banners/banner-9.jpg' />">
                                                </picture>
                                                <div class="card-overlay">
                                        ...
                                        <div class="col-12 col-md-6 d-flex">
                                            <div class="card position-relative overflow-hidden">
                                                <picture class="position-relative z-index-10 d-block bg-light">
                                                    <img class="w-100 rounded"
                                                        alt="HTML Bootstrap Template by Pixel Rocket"
                                                        src="<c:url value='images/banners/banner-10.jpg' />">
                                                </picture>
                                                <div class="card-overlay">
                                        ...
                                        <div class="col-12 col-md-6 d-flex">
                                            <div class="card position-relative overflow-hidden">
                                                <picture class="position-relative z-index-10 d-block bg-light">
                                                    <img class="w-100 rounded"
                                                        alt="HTML Bootstrap Template by Pixel Rocket"
                                                        src="<c:url value='images/banners/banner-11.jpg' />">
                                                </picture>
                                                <div class="card-overlay">
